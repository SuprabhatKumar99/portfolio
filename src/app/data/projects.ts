...
export const PROJECTS_DATA: Project[] = [
  ...
  },
  {
    "slug": "cloudforge",
    "title": "CloudForge",
    "tagline": "A distributed cloud-native platform built around microservices, containers, messaging, and deployment automation.",
    "description": "An ongoing enterprise-style cloud-native microservices project using Spring Boot, Kafka, Redis, PostgreSQL, Docker, Kubernetes, MinIO, Gitea, and supporting infrastructure services.",
    "featured": true,
    "status": "in-progress",
    "thumbnail": "assets/projects/cf-thumbnail.png",
    "heroImage": "assets/projects/cf-hero.png",
    "technologies": [
      {
        "name": "Spring Boot",
        "category": "backend"
    ...
    "problem": "Modern software platforms require independent services, asynchronous communication, containerized infrastructure, source control integration, storage, and deployment workflows without creating a tightly coupled monolith.",
    "solution": "Developing CloudForge as a distributed cloud-native platform composed of independent Spring Boot services connected through infrastructure such as Kafka, Redis, PostgreSQL, Docker, and Kubernetes.",
    "architecture": "Client -> API Gateway -> independent Spring Boot microservices -> Kafka/Redis -> service-specific PostgreSQL databases -> Gitea/MinIO and deployment infrastructure -> Kubernetes.",
    "challenges": [
      "Managing communication and networking across multiple microservices.",
      "Running and connecting containerized services through Docker and Kubernetes.",
      "Integrating Kafka, Redis, PostgreSQL, Gitea, and MinIO into a coherent platform.",
      "Debugging distributed service interactions and deployment workflows."
    ],
    "outcomes": [
      "Built an enterprise-style distributed microservices environment.",
      "Integrated messaging, caching, databases, object storage, source control, and container orchestration.",
      "Gained hands-on experience with cloud-native architecture and Kubernetes-based deployments."
    ],
    "githubUrl": "",
    "liveUrl": "",
    "startDate": "",
